...
#define BASICS_CANVAS_HEADER
    ...
    namespace basics
    {
        ...
        public:
            ...
            //ADDED
            virtual void fill_rectangle (const Point2f & where, const Size2f & size, const basics::Texture_2D * texture,const Point2f & positionUse,const Size2f & sizeUse, int anchor = CENTER){}
