...
#define BASICS_OPENGLES_CANVAS_ES2_HEADER
    ...
    namespace basics { namespace opengles
    {
        ...
        public:
			...
			void fill_rectangle  (const Point2f & where, const Size2f & size, const basics::Texture_2D * texture, const Point2f & positionUse, const Size2f & sizeUse,int anchor = CENTER) override;
        };
